...
class SequentialMatrixCellsCore(nn.Module):
    ...
    def __init__(
        ...
        target(1, ("small_refine", "identity", "block_compare", "class_pair_contrast", "residual_refdelta", "bilinear", "matrix_mlp", "normalize"))
        target(2, ("keep_prev", "small_refine", "memory_read", "memory_write", "ema_memory", "class_pair_memory", "suppress", "normalize", "residual_refdelta", "late_read_repair"))
        target(3, ("noop", "keep_prev", "global_summary", "energy_count", "suppress", "memory_write", "ema_memory", "block_compare"))
        ...
        role_ops("transform", ("identity", "small_refine", "matrix_mlp", "bilinear", "normalize", "residual_refdelta", "time", "freq"))
        role_ops("memory", ("memory_read", "memory_write", "ema_memory", "class_pair_memory", "matrix_mlp", "residual_refdelta", "normalize"))
        role_ops("repair", ("noop", "identity", "keep_prev", "small_refine", "residual_refdelta", "suppress", "normalize", "class_pair_contrast", "late_read_repair", "class_pair_memory"))
        role_ops("aggregate", ("global_summary", "energy_count", "memory_write", "ema_memory", "suppress", "block_compare"))
        role_ops("suppress", ("noop", "identity", "keep_prev", "suppress", "normalize", "block_compare", "global_summary"))
        ...
        category_ops("repair", ("noop", "identity", "keep_prev", "small_refine", "residual_refdelta", "class_pair_contrast", "class_pair_memory", "late_read_repair", "suppress", "normalize"))
        category_ops("aggregate", ("global_summary", "energy_count", "memory_write", "ema_memory", "block_compare"))
        category_ops("suppress", ("noop", "identity", "keep_prev", "suppress", "normalize", "block_compare"))
        category_ops("transform", ("identity", "small_refine", "mlp", "matrix_mlp", "bilinear", "normalize", "time", "freq", "offset", "residual_refdelta"))
...
class SeqAccumulator:
    ...
    def summary(self, classes: List[str]) -> Dict[str, Any]:
        ...
        op_names = list(SequentialMatrixCellsCore.OP_NAMES)
