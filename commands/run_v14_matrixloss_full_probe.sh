...
V14_LR="${V14_LR:-5e-4}" \
V14_LAMBDA_WRITE_BUDGET="${V14_LAMBDA_WRITE_BUDGET:-0.04}" \
V14_WRITE_TARGET="${V14_WRITE_TARGET:-0.72}" \
V14_LAMBDA_OP_ENTROPY_FLOOR="${V14_LAMBDA_OP_ENTROPY_FLOOR:-0.015}" \
V14_OP_MIN_ENTROPY="${V14_OP_MIN_ENTROPY:-0.35}" \
V14_LAMBDA_OP_USAGE_BALANCE="${V14_LAMBDA_OP_USAGE_BALANCE:-0.006}" \
V14_LAMBDA_SLOT_DIVERSITY="${V14_LAMBDA_SLOT_DIVERSITY:-0.002}" \
