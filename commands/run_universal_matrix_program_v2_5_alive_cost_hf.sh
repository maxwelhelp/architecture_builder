...
python experiments/universal_program/run_universal_matrix_program_v2_5_alive_cost.py \
  ...
  --late-growth-penalty 0.25 \
  --descriptor-action-boost 0.08 \
  --soft-prune-strength 0.45 \
  --alive-init-logit 2.2 \
  --alive-floor 0.05 \
  --lambda-op-cost 0.004 \
  --lambda-alive-sparsity 0.001 \
  --candidate-primitive-cost 0.85 \
  --out-dir ./runs/universal_matrix_program_v2_5_alive_cost_hf_45ep
